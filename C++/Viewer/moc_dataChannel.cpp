/****************************************************************************
** Meta object code from reading C++ file 'dataChannel.h'
**
...
#error "The header file 'dataChannel.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 36, 7), // "newData"
QT_MOC_LITERAL(5, 44, 11) // "checkBuffer"

    },
    "dataChannel\0newImage\0\0setConnection\0"
    "newData\0checkBuffer"
};
...
void dataChannel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dataChannel::newImage)) {
                *result = 0;
                return;
            }
        }
