...
dirs('Run') = fullfile(dirs('Root'), 'Data', sdr);
    ...
    dirs('Analysis')    = fullfile(dirs('Run'), 'Analysis');
        ...
        dirs('meanstack')     = fullfile(dirs('Analysis'), 'meanstack.stack');
            tags('meanstack')     = fullfile(dirs('meanstack'), 'meanstack');
        dirs('meanactivity')     = fullfile(dirs('Analysis'), 'meanactivity.stack');
            tags('meanactivity')     = fullfile(dirs('meanactivity'), 'meanactivity');
