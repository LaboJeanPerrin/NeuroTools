...
T = {'HM lower' num2str(this.HM_Position_min) 'µm' ; ...
     'HM higher' num2str(this.HM_Position_max) 'µm' ; ...
     'HM coeff' num2str(this.HM_um2V) 'µm/V' ; ...
     'VM pos' num2str(this.VM_Position) 'µm' ; ...
     'VM coeff' num2str(this.VM_um2V) 'µm/V' ; ...
     'OP pos' num2str(this.OP_Position) 'µm' ; ...
     'OP coeff' num2str(this.OP_um2V) 'µm/V'};
...
if this.NLayers>1
    ...
    T = [T ; {'DelayLong' num2str(this.DelayLong) 'ms'; ...
        ...
        'Increment' num2str(this.Increment) 'µm' ; ...
